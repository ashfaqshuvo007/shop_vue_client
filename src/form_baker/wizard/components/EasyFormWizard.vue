<template>
	<div :class="[stepSize, {vertical: isVertical}]" @keyup.left="focusPrevTab" @keyup.right="focusNextTab"
		...
		<div class="wizard-navigation">
			<div class="wizard-progress-with-circle" v-if="!isVertical">
				<div :style="progressBarStyle"
					 class="wizard-progress-bar"></div>
			</div>
			<ul :class="stepsClasses" class="wizard-nav wizard-nav-pills" role="tablist">
				<slot :index="index" :navigate-to-tab="navigateToTab"
					  :step-size="stepSize"
					  :tab="tab"
					  :transition="transition"
					  name="step"
					  v-for="(tab, index) in tabs">
					<wizard-step :index="index"
								 :step-size="stepSize"
								 :tab="tab"
								 :transition="transition"
		...
		<div class="wizard-card-footer clearfix" v-if="!hideButtons">
          ...
          <span @click="prevTab" @keyup.enter="prevTab" role="button" tabindex="0" v-if="displayPrevButton">
            <slot name="prev" v-bind="slotProps">
              <wizard-button :disabled="loading"
				...
				<div class="wizard-footer-right">
					...
					<span @click="nextTab" @keyup.enter="nextTab" role="button" tabindex="0" v-if="isLastStep">
...
<script>
	import WizardButton from './EasyWizardButton.vue'
	import WizardStep from './EasyWizardStep.vue'
	import {isPromise, findElementAndFocus, getFocusedTabIndex} from './EasyWizardHelper'
